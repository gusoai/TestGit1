...
<html>
	...
	<!-- start danpin -->
		...
		$(function(){
			$.ajax({
				type:"get",
				url:"${pageContext.request.contextPath}/queryGradeGoods?grade=1",
				dataType:"json",
				success:function(data){
					if(data.code == 1){
						...
						$(infos).each(function(){
							var html = "<li>";
							html +=	"<a href=''>" + this.gradeName +"</a>";
								
							html +=	"	<div class='pop'>";
							html +=	"		<div class='left fl'>";
							var ginfos = this.goodsList;
							$(ginfos).each(function(){
								html +=	"			<div>";
								html +=	"				<div class='xuangou_left fl'>";
								html +=	"					<a href=''>";
								html +=	"						<div class='img fl'><img src='images/" + this.imgPath + "' width='40' alt=''></div>";
								html +=	"						<span class='fl'>" + this.goodsName + "</span>";
								html +=	"						<div class='clear'></div>";
								html +=	"					</a>";
								html +=	"				</div>";
								html +=	"				<div class='xuangou_right fr'><a href='./xiangqing.html' target='_blank'>选购</a></div>";
								html +=	"				<div class='clear'></div>";
								html +=	"			</div>";
							})
							html +=	"		</div>";
